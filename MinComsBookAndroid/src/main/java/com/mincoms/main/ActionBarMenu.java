...
public class ActionBarMenu {
	...
	public void remove(int id){
	 ...
	 public class LogOutAsyncTask extends AsyncTask<Void, Void, RestClient> {
			@Override
			protected RestClient doInBackground(Void... params) {
				RestClient restClient = null;
				try {
					String url = context.getString(R.string.base_uri) + "/logout";
			...
			protected void onPostExecute(RestClient restClient) {
				...
				if(statusCode==200){
					  MainActivity.topActivity.finish();
