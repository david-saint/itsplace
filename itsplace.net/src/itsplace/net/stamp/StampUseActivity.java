...
public class StampUseActivity  extends AbstractAsyncActivity{
       ...
       protected String doInBackground(Void... params) {
		...
		protected void onPostExecute(String result){
			...
			if(result.equals("true")){
				Toast.makeText(StampUseActivity.this, "적립 했어요"+result, Toast.LENGTH_SHORT).show();
				finish();
			}else{
				Toast.makeText(StampUseActivity.this, "적립 실패 했어요 알 수 없는 오류 발생"+result, Toast.LENGTH_SHORT).show();
			}
