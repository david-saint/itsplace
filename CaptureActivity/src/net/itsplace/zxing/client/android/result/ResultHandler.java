...
package net.itsplace.zxing.client.android.result;
...
import net.itsplace.zxing.client.android.Contents;
import net.itsplace.zxing.client.android.Intents;
import net.itsplace.zxing.client.android.LocaleManager;
import net.itsplace.zxing.client.android.PreferencesActivity;
import net.itsplace.zxing.client.android.R;
import net.itsplace.zxing.client.android.book.SearchBookContentsActivity;
