...
public class PlaceExceptionResolver extends SimpleMappingExceptionResolver {
	private static final Logger logger = LoggerFactory.getLogger(PlaceExceptionResolver.class);
