...
<div class="text_success"><img src="<c:url value="/resources/admin/images/loadder/loader_green.gif" />"  alt="ziceAdmin" /><span>Please wait</span></div>

<div id="login" >
  <div class="ribbon"></div>
  <div class="inner">
  <div class="logo" ><img src="<c:url value="/resources/admin/images/logo/logo_login.png" />" alt="ziceAdmin" /></div>
  <div class="formLogin">
