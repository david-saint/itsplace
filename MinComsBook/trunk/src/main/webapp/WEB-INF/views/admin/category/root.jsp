		 			 ...
		 			 animation: {
		 			  ...
		 			  buttons: [
		 			    {addClass: 'uibutton normal', text: '확 인', onClick: function($noty) {
		 		 			var url = "${context}/admin/category/root/delete?id=";
...
<div class="widget">
	...
	<div class="content">
		<form:form  action="${context}/admin/category/root/save" commandName="bookCategoryRoot" method="post">
          ...
          <table class="display">
			...
			<tbody>
				...
				<tr>
					...
					<td><span class="tip"><a class="edit iframe" href="${context}/admin/category/root?id=${bookCategoryRoot.id}" original-title="수정"><img src="${context}/resources/images/icon/gray_18/pencil.png"></a><span>
					<span class="tip"><a class="delete iframe" id="${bookCategoryRoot.id}" original-title="삭제"><img src="${context}/resources/images/icon/gray_18/delete.png"></a><span></td>
				</tr>
				</c:forEach>
			</tbody>	
          </table>       	 
