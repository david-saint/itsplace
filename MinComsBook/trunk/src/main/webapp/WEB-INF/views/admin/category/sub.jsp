...
<div class="widget">
	...
	<div class="content">
		<form:form  action="${context}/admin/category/sub/save" commandName="bookCategorySub" method="post">
          ...
          <table class="display">
			...
			<tbody>
				...
				<tr>
					...
					<td><span class="tip"><a class="edit iframe" href="${context}/admin/category/sub?id=${bookCategorySub.id}" original-title="수정"><img src="${context}/resources/images/icon/gray_18/pencil.png"></a><span>
					<span class="tip"><a class="delete iframe" id="${bookCategorySub.id}" original-title="삭제"><img src="${context}/resources/images/icon/gray_18/delete.png"></a><span></td>
				</tr>
				</c:forEach>
			</tbody>	
          </table>       	 
